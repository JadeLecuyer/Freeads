...
<div class="container">
    ...
    <div class="row row-cols-1 row-cols-md-2 py-2">
        <div class="col mb-4 mb-md-0">
            <img src="{{ asset($ad->picture) }}" alt="{{ $ad->title }}" class="d-block m-auto mw-100">
        </div>
        <div class="col">
            ...
            <p class="h5 my-4">{{ $ad->price }}$</p>
            <a href="tel:{{ $seller->phone }}" class="btn btn-custom-secondary--negative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-telephone btn__logo mr-1" viewBox="0 0 16 16">
